...
define(function(require) {
	var BasicBundle = require('bundle')
		.extend({
			...
			create: function(args) {
				this.createComponentPool(function() {
					return require('circle-collider')
				});

				this.createComponentPool(function() {
					return require('polygon-collider')
				});

				this.createComponentPool(function() {
					return require('fixed-polygon-collider')
				});

				this.createComponentPool(function() {
					return require('path-renderer')
				});
				...
				this.createDynamicGameObjectPool(function() {
					return require('game-object')
				});
				this.createDynamicGameObjectPool(function() {
					return require('game-object-container')
				});
			},
			/**
			 * --------------------------------
