require.config({ 
	...
	paths: { 
		...
		"asset-preloader": "../../game-builder/src/asset-preloader", 
		...
		"rgb-canvas-cache": "../../game-builder/src/cache/rgb-canvas-cache", 
		...
		"add-component": "../../game-builder/src/components/add-component", 
		"add-game-object": "../../game-builder/src/components/add-game-object", 
		"component": "../../game-builder/src/components/component", 
		"animation-bitmap-renderer": "../../game-builder/src/components/rendering/animation-bitmap-renderer", 
		"animation-path-renderer": "../../game-builder/src/components/rendering/animation-path-renderer", 
		"animations-bitmap-renderer": "../../game-builder/src/components/rendering/animations-bitmap-renderer", 
		"animations-path-renderer": "../../game-builder/src/components/rendering/animations-path-renderer", 
		...
		"sound-component": "../../game-builder/src/components/sound-component", 
		...
		"child-finder": "../../game-builder/src/hierarchy/helpers/child-finder", 
		"component-finder": "../../game-builder/src/hierarchy/helpers/component-finder", 
		"visibility-control": "../../game-builder/src/hierarchy/helpers/visibility-control", 
		...
		"component-configuration": "../../game-builder/src/pools/component-configuration", 
		"component-pool": "../../game-builder/src/pools/component-pool", 
		"game-object-configuration": "../../game-builder/src/pools/game-object-configuration", 
		...
		"preload-assets": "src/preload-assets", 
