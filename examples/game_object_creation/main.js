...
define(function(require){
	...
	// Getting the prototype for [basic-game-object](http://localhost:5000/examples-docs/common_src/basic-game-object.html)
	var basic_game_object = require('basic-game-object'); 
	// Getting the prototype for [box-renderer](http://localhost:5000/examples-docs/common_src/box-renderer.html) component
	var box_renderer = require('box-renderer');

	// This is the main initialization function
	game.on(game.CREATE, this, function() {
		console.log('Welcome to Game-Builder!');
		// Create a pool of [box-renderer](http://localhost:5000/examples-docs/common_src/box-renderer.html) objects and give it the id **Box_Renderer**.
		...
		// Create a [basic-game-object](http://localhost:5000/examples-docs/common_src/basic-game-object.html) pool and give it the id **Base**.
