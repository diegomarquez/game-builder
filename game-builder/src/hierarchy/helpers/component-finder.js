 ...
 *
 * This module encapsulates the logic to search for [components](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/component.html) of a [game-object](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/game-object.html)
 *
 * Call the **findComponents** method of a [game-object](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/game-object.html) to get a handle of this object.
 *
 * Ej.
 *
 * ``` javascript
...
define(function() {
	 ...
	 *
	 * Chain this method to set the current [game-object](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/game-object.html) that will be affected
	 *
	 * @param {Object} user
	 *
	 ...
	 *
	 * Chain this method to select all the [components](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/component.html) that return true for the given function
	 *
	 * @param {Function} f Test function to decide whether a [component](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/component.html) should be returned or not in the result.
	 *
	 * @return {Array}
	 */
	 ...
	 *
	 * Chain this method to search for [components](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/component.html) with a matching poolId or typeId
	 *
	 * @param {String} type
	 *
	 * @return {Array}
	 ...
	 *
	 * Chain this method to select the first [component](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/component.html) that returns true for the given function
	 *
	 ...
	 * <p style='color:#AD071D'><strong>firstWithType</strong></p>
	 *
	 * Chain this method to search for the first [component](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/component.html) with a matching poolId or typeId
	 *
	 * @param {String} prop
	 *
	 * @return {Object | null}
