...
define(["delegate", "root", "group", "error-printer"], function(Delegate, Root, Group, ErrorPrinter) {
	...
	var GroupContainer = Delegate.extend({
		 ...
		 * @param {Boolean} [skipEvents=false] Whether to skip the **HIDE** and **STOP** events of the corresponding [group](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/group.html)
		 */
		 ...
		 * @param {Boolean} [skipEvents=false] Whether to skip the **SHOW** and **RUN** events of the corresponding [group](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/group.html)
		 */
		 ...
		 * @param {Boolean} [skipEvents=false] Whether to skip the **HIDE** event of the corresponding [group](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/group.html)
		 */
		 ...
		 * @param {Boolean} [skipEvents=false] Whether to skip the **SHOW** event of the corresponding [group](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/group.html)
		 */
		 ...
		 * @param {Boolean} [skipEvents=false] Whether to skip the **STOP** event of the corresponding [group](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/group.html)
		 */
		 ...
		 * @param {Boolean} [skipEvents=false] Whether to skip the **RUN** event of the corresponding [group](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/group.html)
		 */
		 ...
		 * @param {Boolean} [skipEvents=false] Whether to skip the events of the corresponding [groups](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/group.html)
		 */
