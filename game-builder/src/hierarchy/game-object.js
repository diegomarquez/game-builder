...
define(["delegate", "matrix-3x3", "game-object-debug-draw"], function(Delegate, Matrix, DebugDraw) {
	...
	var GameObject = Delegate.extend({
		 ...
		 * callback.
		 *
		 * @param {[renderer](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/rendering/renderer.html)} renderer
		 */
		 ...
		 * 
		 * @param {[component](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/component.html)} component 
		 */
		 ...
		 *
		 * It also triggers the event that will send it back to the [component-pool](http://diegomarquez.github.io/game-builder/game-builder-docs/src/pools/component-pool.html)
		 * 
		 * @param  {[component](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/component.html)} component
		 */
		 ...
		 * in game objects nested in [game-object-container](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/game-object-container.html) objects
		 ...
		 * 
		 * @param  {[matrix-3x3](http://diegomarquez.github.io/game-builder/game-builder-docs/src/math/matrix-3x3.html)} [m=new Matrix()] A matrix object into which put result.
		 *
		 * @return {[matrix-3x3](http://diegomarquez.github.io/game-builder/game-builder-docs/src/math/matrix-3x3.html)} The concatenated [matrix-3x3](http://diegomarquez.github.io/game-builder/game-builder-docs/src/math/matrix-3x3.html)
		 */
