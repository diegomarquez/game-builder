 ...
 * [layer](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/layer.html)
 ...
 * 
 * This module defines an object to contain and work with [layer](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/layer.html) objects.
 *
...
define(["root", "layer", "error-printer"], function(Root, Layer, ErrorPrinter) {
	 ...
	 * it also is added to [root](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/root.html), which is what will actually make it
	 * display.
	 *
	 ...
	 *
	 * Removes a layer from the array in this object, and also from the [root](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/root.html).
	 * Prior to removing the layer it also clears it from any [game-objects](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/game-object.html)
	 *
	 * A removed layer can not be used again, if you wish to just remove all [game-objects](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/game-object.html)
	 ...
	 *
	 * Clears a layer from all [game-objects](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/game-object.html)
	 *
	 ...
	 *
	 * @throws {Error} If the provided name does not match any [layer](http://diegomarquez.github.io/game-builder/game-builder-docs/src/hierarchy/layer.html)
	 * 
