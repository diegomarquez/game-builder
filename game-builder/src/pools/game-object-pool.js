 ...
 *
 * Depends of:
 * [game-object-configuration](http://diegomarquez.github.io/game-builder/game-builder-docs/src/pools/game-object-configuration.html)
...
define(function(require) {
	...
	var GameObjectPool = require('pool')
		.extend({
			 ...
			 *
			 * Creates a [game-object-configuration](http://diegomarquez.github.io/game-builder/game-builder-docs/src/pools/game-object-configuration.html) for the given type of pooled object.
			 *
			 * @param {String} alias The id that will be used to retrieve this [game-object-configuration](http://diegomarquez.github.io/game-builder/game-builder-docs/src/pools/game-object-configuration.html)
			 * @param {String} type With this id the [game-object-configuration](http://diegomarquez.github.io/game-builder/game-builder-docs/src/pools/game-object-configuration.html) has the information needed
			 * to know to which pool of objects it refers to
			 *
			 * @return {Object} A [game-object-configuration](http://diegomarquez.github.io/game-builder/game-builder-docs/src/pools/game-object-configuration.html) object.
			 */
