 ...
 *
 * Depends of:
 * [component-configuration](http://diegomarquez.github.io/game-builder/game-builder-docs/src/pools/component-configuration.html)
...
define(function(require) {
	var ComponentPool = require('pool')
		.extend({
			/**
			 * <p style='color:#AD071D'><strong>createConfiguration</strong></p>
			 *
			 * Creates a [component-configuration](http://diegomarquez.github.io/game-builder/game-builder-docs/src/pools/component-configuration.html) for the given type of pooled object.
			 *
			 * @param {String} alias The id that will be used to retrieve this [component-configuration](http://diegomarquez.github.io/game-builder/game-builder-docs/src/pools/component-configuration.html)
			 * @param {String} type With this id the [component-configuration](http://diegomarquez.github.io/game-builder/game-builder-docs/src/pools/component-configuration.html) has the information needed
			 * to know to which pool of objects it refers to
			 *
			 * @return {Object} A [component-configuration](http://diegomarquez.github.io/game-builder/game-builder-docs/src/pools/component-configuration.html) object.
			 */
				...
				if (pool.objects.length <= 0) {
					...
					if (!ok) {
						require('error-printer')
							.printError('Component Pool', 'Component with id: ' + configuration.componentId + ' is not available');
					}
				}
			...
			getConfigurationObject: function(alias) {
				...
				if (!configuration) {
					require('error-printer')
						.printError('Component Pool', 'Configuration with id: ' + alias + ' does not exist');
				}
