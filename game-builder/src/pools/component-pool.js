 ...
 * 
 * This module defines the component pool. All the required instances of [component](http://localhost:5000/game-builder-docs/src/components/component.html)
 * objects are held in here. 
 * 
 * As [game-objects](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html) are assembled by [assembler](http://localhost:5000/game-builder-docs/src/pools/assembler.html), 
 * [component](http://localhost:5000/game-builder-docs/src/components/component.html) objects might be needed, at that point they are instantiated.
 ...
 * saying that there are no more [components](http://localhost:5000/game-builder-docs/src/components/component.html) of that type available.
 *
 * Unlike [game-objects](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html), [components](http://localhost:5000/game-builder-docs/src/components/component.html) don't make sense by themselves, so
 * you don't specify the maximun amount of them you want, like you do with the [game-object-pool](http://localhost:5000/game-builder-docs/src/pools/game-object-pool.html). 
 * Instead [components](http://localhost:5000/game-builder-docs/src/components/component.html) will be created as needed. Since [components](http://localhost:5000/game-builder-docs/src/components/component.html),
 * can not exists outside of a [game-object](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html), when the cap on [game-objects](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html)
 * is reached, naturally, no more [components](http://localhost:5000/game-builder-docs/src/components/component.html) will be created.
 *
 * From that point, if a [game-object](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html) is recycled all of it's [components](http://localhost:5000/game-builder-docs/src/components/component.html) will
 * be recycled aswell, freeing them to be used in another [game-object](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html) if needed.
 *
 * This pool also stores configurations for [component](http://localhost:5000/game-builder-docs/src/components/component.html) instances. 
...
define(function(require) {
	var ComponentPool = require('pool').extend({
		...
		createConfiguration: function(alias, type) {
			...
			// Configuration objects for [components](http://localhost:5000/game-builder-docs/src/components/component.html)
		 ...
		 *
		 * Gets a configuration for the requested [component](http://localhost:5000/game-builder-docs/src/components/component.html).
		 *
		 * @param  {String} alias      Id of the [component](http://localhost:5000/game-builder-docs/src/components/component.html) requested
