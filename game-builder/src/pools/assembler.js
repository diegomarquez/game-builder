 ...
 *
 * The assembler module takes care of putting together the [game-objects](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html) with their
 * [components](http://localhost:5000/game-builder-docs/src/components/component.html) as they were configured in the [game-object-pool](http://localhost:5000/game-builder-docs/src/pools/game-object-pool.html)
 * and [component-pool](http://localhost:5000/game-builder-docs/src/pools/component-pool.html) respectively. 
 *
 * In addition you are able to override the configured arguments, or add new ones when you
 * request a [game-object](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html). When a [game-object](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html) is
 ...
 *
 * The object responsible for recycling [game-objects](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html) is [reclaimer](http://localhost:5000/game-builder-docs/src/pools/reclaimer.html).
 */
...
define(['game-object-pool', 'component-pool', 'util', 'error-printer'], function(GameObjectPool, ComponentPool, Util, ErrorPrinter) {
	 ...
	 *
	 * It returns a [game-object](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html) ready to be started.
	 * 
	 * @param  {String} name       Id of the [game-object](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html) we want assembled. It should be an existing configured id on the [game-object-pool](http://localhost:5000/game-builder-docs/src/pools/game-object-pool.html)
	 ...
	 * 
	 * @throws {Error} If a [game-object](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html) was configured to have childs. Only [game-object-containers](http://localhost:5000/game-builder-docs/src/hierarchy/game-object-container.html) can have nested childs
	 * 
	 * @return {Object} A [game-object](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html) ready to be used
	 */
	 ...
	 *
	 * It returns a [game-object](http://localhost:5000/game-builder-docs/src/hierarchy/game-object.html) ready to be started. If the object is not available in the [game-object-pool](http://localhost:5000/game-builder-docs/src/pools/game-object-pool.html)
	 ...
	 *
	 * It returns a [component](http://localhost:5000/game-builder-docs/src/components/component.html) ready to be started. If the object is not available in the [component-pool](http://localhost:5000/game-builder-docs/src/pools/component-pool.html)
	 * it will be created every time.
	 * 
	 * @param  {String} name       Id of the [component](http://localhost:5000/game-builder-docs/src/components/component.html). It should be an existing configured id on the [component-pool](http://localhost:5000/game-builder-docs/src/pools/component-pool.html)
	 * @param  {Object} [args=null] All the properties in this object will be copied to the [component](http://localhost:5000/game-builder-docs/src/components/component.html). 
	 * 
	 * @return {Object} A [component](http://localhost:5000/game-builder-docs/src/components/component.html) ready to be used
	 */
