...
define(function(require) {
	...
	var Timer = require('delegate').extend({
		...
		/**
		 * <p style='color:#AD071D'><strong>on</strong> Wrapper to <a href=http://diegomarquez.github.io/game-builder/game-builder-docs/src/delegate.html>delegate</a> method of the same name</p>
