 ...
 *
 * This module is similar to [animation-path-renderer](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/rendering/animation-path-renderer.html), with the difference that it assumes less things
