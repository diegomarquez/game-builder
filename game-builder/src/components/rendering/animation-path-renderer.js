 ...
 *
 * This module is similar to [path-renderer](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/rendering/path-renderer.html) with the difference that it let's you define many drawings that will
 ...
 *
 * For a little bit more control (and complexity) try using [animations-path-renderer](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/rendering/animations-path-renderer.html)
 *
