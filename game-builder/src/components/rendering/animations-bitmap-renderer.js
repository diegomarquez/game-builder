 ...
 *
 * This module is similar to [animation-bitmap-renderer](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/rendering/animation-bitmap-renderer.html), with the difference that it assumes less things
