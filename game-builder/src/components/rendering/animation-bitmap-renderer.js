 ...
 *
 * This module is similar to [bitmap-renderer](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/rendering/bitmap-renderer.html) with the difference that it takes an image containing a strip of frames
 ...
 *
 * For a little bit more control (and complexity) try using [animations-bitmap-renderer](http://diegomarquez.github.io/game-builder/game-builder-docs/src/components/rendering/animations-bitmap-renderer.html)
 *
