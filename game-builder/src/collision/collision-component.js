 ...
 * is checking if it is colliding against any of the objects the [collision-resolver](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/collision/collision-resolver.html)
 * is saying it should collide against.
 *
 * When setting up the [component-pool](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/pools/component-pool.html) with collider components, be sure
 * to checkout the documentation for [circle-collider](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/collision/circle-collider.html), [polygon-collider](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/collision/polygon-collider.html)
 * and [fixed-polygon-collider](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/collision/fixed-polygon-collider.html) to see what kind of object they expect as an argument
...
define(['component', 'collision-resolver', 'error-printer'], function(Component, CollisionResolver, ErrorPrinter) {
	...
	var CollisionComponent = Component.extend({
		 ...
		 * adds itself to the [collision-resolver](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/collision/collision-resolver.html)
		 *	
		 ...
		 * 
		 * The [collision-resolver](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/collision/collision-resolver.html) will test this collider against
		 ...
		 * 
		 * @param  {Object} other The other [game-object](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/hierarchy/game-object.html) involved in the collision.
		 */
		 ...
		 * from the [collision-resolver](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/collision/collision-resolver.html)
		 */
		destroy: function() {
			this._super();
