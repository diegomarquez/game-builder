 ...
 * the ability to collide against other [game-objects](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/hierarchy/game-object.html) with collider components.
 *
 * Since this is a circle collider there is not much about it, other than a radius. Other than
 * that it follows it's [game-object](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/hierarchy/game-object.html) parent around.
 *
 * During the configuration of the [component-pool](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/pools/component-pool.html) circle colliders need to 
...
define(['collision-component', 'sat', 'collision-resolver', 'vector-2D', 'draw'],
	...
	var Component = CollisionComponent.extend({
		 ...
		 * Set up the collider.
		 * 
		 * Creates a Circle object defined in the [sat](file://localhost/Users/johndoe/game-builder-gh-pages/game-builder-docs/src/collision/sat.html) module.
		 */
		start: function() {
			this._super();
