...
define(["viewport", "error-printer"], function(Viewport, ErrorPrinter) {
	 ...
	 * @param {Number} height  Hidth of the new [viewport](http://diegomarquez.github.io/game-builder/game-builder-docs/src/view/viewport.html)
	 ...
	 *
	 * @return {Object} The newly created [viewport](http://diegomarquez.github.io/game-builder/game-builder-docs/src/view/viewport.html)
	 */
	 ...
	 *
	 * Get a reference to the underlaying object containing all the created [viewports](http://diegomarquez.github.io/game-builder/game-builder-docs/src/view/viewports.html)
	 */
